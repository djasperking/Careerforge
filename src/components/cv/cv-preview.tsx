 ...
 */
export function CvPreview({ content, template }: { content: CVContent; template: CvTemplateConfig }) {
  ...
  return (
    <div
      className="mx-auto w-full max-w-[720px] bg-white p-8 text-[13px] leading-relaxed text-neutral-900 shadow-sm print:shadow-none"
