        ...
        <CardContent className="p-6">
          <SettingsForm
            initial={{
              ...
              payoutHoldDays: typeof values["payouts.holdDays"] === "number" ? values["payouts.holdDays"] : 7,
              payoutMinimumNaira: (typeof values["payouts.minimumCents"] === "number" ? values["payouts.minimumCents"] : 500_000) / 100,
